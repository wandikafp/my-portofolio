...
smart_shopper_page = st.Page("pages/smart_shopper.py", title="Smart Shopper AI", icon="🛍️")
...
pg = st.navigation(
    {"": [home_page, proyek_page], "Demo": [ser_page, smart_shopper_page, prediksi_page, chatbot_page]},
    position="sidebar"
)
